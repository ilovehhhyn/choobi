...
document.querySelector('#tui-form').addEventListener('submit', event => {
  ...
  else if (command === 'hello') { pet.click(); tuiMessage('(^_^) hello, favourite human.', 'you make something good. i’ll keep the notes.'); }
